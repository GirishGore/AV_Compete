...
dt = DecisionTreeRegressor() ## Default is 10

from sklearn.model_selection import cross_val_score

scores = cross_val_score (dt , X , y , scoring="neg_mean_squared_error", cv = 5)

print("Root Mean Squared Error" , np.sqrt(-scores))
print(scores)

predicted= dt.predict(data_test.drop(['is_Train'] , axis=1))
print(dt)
...
Submit.to_csv('E:\\Work\\AV_Compete\\BlackFriday\\DT_Latest.csv', index= False)
